...
describe('IPC Tickets', () => {
  it('valide le renderer avant chaque lecture et d?l?gue au service', async () => {
  ...
  it('annule r?ellement une lecture active ? la demande du renderer', async () => {
  ...
  it('isole les m?mes requestId entre deux senders', async () => {
    const { handlers, service } = setup()
  ...
  it('n?expose jamais la fixture hors instance isol?e', async () => {
  ...
  it('installe une page d?terministe uniquement en instance isol?e', async () => {
