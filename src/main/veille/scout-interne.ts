...
export function construirePromptScoutInterne(params: ParametresScoutInterne): string {
  return [
    ...
    '2. Écris ensuite une courte synthèse humaine en Markdown SOBRE (pas de HTML) : une liste des',
    '   chemins réellement lus, 2-3 lignes sur ce que l’usage montre, puis un petit tableau',
    '   `Titre | Ancrage | Pertinence` des candidats retenus. C’est elle que l’utilisateur lira.',
