...
ANCRAGE ROUVERT : avant de lister un candidat, OUVRE son ancrage file:line et verifie que le defaut est encore OUVERT. Le Why nomme ce que tu viens d'y lire qui le prouve. Le piege a couter un cycle entier le 2026-08-20 : 2 candidats sur 8 etaient DEJA corriges, parce qu'un COMMENTAIRE decrivant la cause passee se lit comme un defaut vivant — le code au-dessus etait deja repare, et son test existait. Un commentaire n'est pas un defaut ; ce qui l'est, c'est le code. Candidat dont tu ne peux pas prouver qu'il est ouvert : ne le liste pas.
PLAFOND DE PREUVE : le Score mesure la PREUVE, pas ta certitude. Un candidat dont le Why repose sur une DEDUCTION plutot qu'une observation directe est PLAFONNE a 50 tant que les chemins fermes ne sont pas nommes. Mesure du 21/08 : 84 et 82 aux deux candidats FAUX, 66 a un vrai — la confiance etait la plus haute la ou la verification etait la plus faible.
CLOTURE NEGATIVE — le reflexe 10, applique au Why. Un Why qui AFFIRME une absence ("rien ne stocke", "personne ne lit", "aucune X ne sait") n'est PAS prouve par un grep : ENUMERE l'espace atteignable, BALAYE-le, et NOMME dans le Why les chemins FERMES — pas l'absence trouvee. Ce depot a TROIS couches de consigne et d'outillage : les SKILL.md du kit, les briefs in-app, et les prompts ENGENDRES depuis le catalogue reel ; un grep n'en voit qu'une. Mesure du 21/08 : 6 hypotheses sur 8 sont mortes ainsi, chacune batie sur un FAIT vrai et une CONSEQUENCE non verifiee. Chemins non epuises : dis-le dans le Why, ne le tais pas.
