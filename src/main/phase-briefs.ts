...
Livrable : un tableau classé aux colonnes EXACTES \`Score | Type | What | Why | How\` (Type = 🔧fix/🆕feature), trié par Score DÉCROISSANT. Score = une note agrégée /100 (valeur × faisabilité) : un ENTIER entre 0 et 100, écrit en chiffres. Jamais une pastille de couleur, jamais « élevé/moyen », jamais un ratio — mesuré le 2026-08-18, une colonne Score remplie de 🟢 rend la shortlist non triable et n'apprend rien de plus que la position de la ligne. Chaque ligne assez précise pour être choisie (un fix porte un file:line + un signal de "fait" mesurable ; une feature porte son 1er pas concret).
