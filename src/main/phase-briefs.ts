...
ANTI-BLOCAGE — un blocage que tu t'inventes coûte un tour. Mesuré le 2026-08-17 (conv-1286) : 21 tours pour une demande d'un tour, dont 3 à redemander une cible déjà écrite dans le fil.
...
- Un outil qui échoue ou pend une fois n'est pas un mur : change de moyen.
