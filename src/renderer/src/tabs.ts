...
export function normalizeTab(t: string): Tab {
  ...
  if (t === 'observatory' || t === 'observatoire' || t === 'harness' || t === 'harnais' || t === 'prompt' || t === 'prompt-load') return 'observatory'
  if (t === 'agents' || t === 'roles') return 'agents'
  if (t === 'skills' || t === 'hooks' || t === 'tools' || t === 'capabilities') return 'capabilities'
