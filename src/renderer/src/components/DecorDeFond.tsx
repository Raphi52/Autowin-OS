...
export function DecorDeFond(): React.JSX.Element {
  ...
  useEffect(() => {
    ...
    const draw = (time: number): void => {
      ...
      /*
       * « MOUVEMENT REDUIT » REDUIT LE MOUVEMENT, il n'efface pas le decor. Le temps est FIGE, donc
       * plus aucune derive autonome — c'est ce que la preference vise. La parallaxe curseur reste :
       * elle ne bouge QUE quand l'utilisateur bouge, c'est de la manipulation directe.
       */
